...
describe('env-variables-util', function () {
    ...
    describe('type', function () {
        describe('type was defined as number', function () {
        ...
        describe('type was defined as boolean', function () {
        ...
        describe('type was defined as string', function () {
        ...
        describe('type was defined as array', function () {
            it('should be string', function () {
